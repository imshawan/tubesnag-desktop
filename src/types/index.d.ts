...
declare global {
	interface Window {
		electron?: {
			...
			getDefaultDownloadLocation: () => Promise<string>;
			...
			openFile: (item: DownloadItem) => Promise<{
				success: boolean;
				error: FileNotFoundError | null
			}>;
			openFolder: (item: DownloadItem) => Promise<{
				success: boolean;
				error: FileNotFoundError | null
			}>;
			...
			db: {
				...
				deleteActiveDownloadsVideoFromPlaylist: (playlistId: string, videoId: string) => Promise<{
					success: boolean
				}>;
				deleteCompletedDownloadsVideoFromPlaylist: (playlistId: string, videoId: string) => Promise<{
					success: boolean
				}>;
