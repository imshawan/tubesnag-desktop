	...
	return (
		...
		>
			...
			>
				{/* Spinning Icon Ring */}
				<div
					className="relative flex items-center justify-center size-10 rounded-full bg-blue-500/10 text-blue-500 shrink-0">
					<Loader2 className="size-10 animate-[spin_3s_linear_infinite] absolute opacity-20"/>
					<Loader2 className="size-10 animate-spin absolute opacity-50"
				...
				<div className="flex flex-col min-w-[140px]">
					...
					{/* Live Metrics */}
					<div
						className="flex items-center gap-2 text-[11px] text-muted-foreground font-mono tracking-wider uppercase">
